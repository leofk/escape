...
// // A container that stores components of type 'Component' and associated entities
// template <typename T, typename S> // A component can be any class
// class LayerContainer : public ContainerInterface
// {
// private:
// public:
// 	// Container of all components of type 'Component'
// 	ComponentContainer<T> current_motions;
// 	ComponentContainer<S> current_renderRequests;
// 	int level_layer;

// 	// Constructor that registers the type
// 	LayerContainer(int i) { this->level_layer = i; };

// 	// Remove an component and pack the container to re-use the empty space
// 	void remove(Entity e)
// 	{
// 		current_motions.remove(e);
// 		current_renderRequests.remove(e);
// 	};

// 	// Remove all components of type 'Component'
// 	void clear()
// 	{
// 		current_motions.clear();
// 		current_renderRequests.clear();
// 	}
// };
